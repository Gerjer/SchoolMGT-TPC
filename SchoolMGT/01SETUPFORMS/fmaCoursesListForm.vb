Public Class fmaCoursesListForm
    ...
    Private TABLENAME As String = "courses"

    Private WithEvents SETUPFORM As fmaCoursesSetupForm
    ...
    Private Sub Attach()
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("code").DataColumn.Caption = "COURSE CODE"
                ...
                .DisplayColumns("section_name").DataColumn.Caption = "MAJOR/SECTION"
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaCoursesSetupForm
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Dim SQLEX As String = "SELECT COUNT(course_id) 'count' FROM batches "
        SQLEX += " WHERE course_id='" & ITEMSYSPK & "'"
        ...
        If MeData.Rows.Count > 0 Then
            ...
            If count > 0 Then
                MsgBox("Cannot Delete Course, there are Batches under it.", MsgBoxStyle.Critical)
                Exit Sub
            End If
        End If
    ...
    Private Sub deleteSelectedItem()
        ...
        Try
            ITEMSYSPK = tdbViewer.Columns.Item(6).Value
        Catch ex As Exception
