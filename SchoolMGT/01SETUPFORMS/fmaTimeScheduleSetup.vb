...
Public Class fmaTimeScheduleSetup
...
#Region "Classes"
    Private Sub AttachClasses()
        ...
        clsGroup.AttachControl = Me.txtstart_time
        clsGroup.AttachControl = Me.txtend_time
...
#End Region
    ...
    Private Sub fmaEmployeeSetupForm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If OPERATION = "ADD" Then
            dtpstart_time.Value = DateTime.Parse("00:00")
            dtpend_time.Value = DateTime.Parse("00:00")
        Else
            dtpstart_time.Value = DateTime.Parse(_startTime)
            dtpend_time.Value = DateTime.Parse(_endTime)
        End If
    ...
    Private Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles dtpstart_time.ValueChanged
        txtname.Text = Format(dtpstart_time.Value, "h:mm tt") & " - " & Format(dtpend_time.Value, "h:mm tt")

        txtstart_time.Text = Format(dtpstart_time.Value, "HH:mm:ss")

    End Sub

    Private Sub DateTimePicker2_ValueChanged(sender As Object, e As EventArgs) Handles dtpend_time.ValueChanged
        txtname.Text = Format(dtpstart_time.Value, "h:mm tt") & " - " & Format(dtpend_time.Value, "h:mm tt")

        txtend_time.Text = Format(dtpend_time.Value, "HH:mm:ss")
