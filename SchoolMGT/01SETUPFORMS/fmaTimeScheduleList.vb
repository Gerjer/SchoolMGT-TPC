Public Class fmaTimeScheduleList
    ...
    Private TABLENAME As String = "class_timings"

    Private WithEvents SETUPFORM As fmaTimeScheduleSetup
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK_Item,Item_Code,name,description,start_time,end_time "
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("Item_Code").Visible = False


                .DisplayColumns("name").DataColumn.Caption = "TIME SCHEDULE"
                .DisplayColumns("name").Width = 600
                ...
                .DisplayColumns("description").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center

                .DisplayColumns("start_time").Visible = False
                .DisplayColumns("end_time").Visible = False
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaTimeScheduleSetup
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        If SETUPFORM Is Nothing Then
            ...
            SETUPFORM._startTime = tdbViewer(row, "start_time").ToString
            SETUPFORM._endTime = tdbViewer(row, "end_time").ToString
        End If
