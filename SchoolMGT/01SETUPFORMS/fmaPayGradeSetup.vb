...
#Region "Classes"
    Private Sub AttachClasses()
        ...
        clsGroup.AttachControl = Me.txtpriority
        clsGroup.AttachControl = Me.txtmax_hours_day
        clsGroup.AttachControl = Me.txtmax_hours_week
