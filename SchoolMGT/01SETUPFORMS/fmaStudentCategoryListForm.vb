Public Class fmaStudentCategoryListForm
    ...
    Private TABLENAME As String = "student_categories"

    Private WithEvents SETUPFORM As fmaStudentCategorySetupForm
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT id,name,no_of_payment,SysPK "
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("name").DataColumn.Caption = "CATEGORY NAME"
                ...
                .DisplayColumns("no_of_payment").DataColumn.Caption = "NO. OF PAYMENTS"
                .DisplayColumns("no_of_payment").Width = 150
                .DisplayColumns("no_of_payment").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("no_of_payment").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
...
#End Region
    ...
    Private Sub searchFilterText()
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("no_of_payment").Width = 150
                .DisplayColumns("no_of_payment").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("no_of_payment").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaStudentCategorySetupForm
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Dim SQLEX As String = "SELECT COUNT(category_id) 'count' FROM courses"
        SQLEX += " WHERE category_id='" & ITEMSYSPK & "'"
        ...
        If MeData.Rows.Count > 0 Then
            ...
            If count > 0 Then
                MsgBox("Cannot Delete Category, there are Courses under it.", MsgBoxStyle.Critical)
                Exit Sub
            End If
        End If
    ...
    Private Sub deleteSelectedItem()
        ...
        Try
            ITEMSYSPK = tdbViewer.Columns.Item(3).Value
        Catch ex As Exception
