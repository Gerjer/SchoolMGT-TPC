...
Public Class fmaOfficialTranscipt9Form
    ...
    Private Sub loadGradeData()
        ...
        SQLEX += " , batches.semester, batches.school_year,subjects.ccid"
        ...
        Try
            Me.AttachReport(SQLEX, "CHED FORM 9 " & txtStudentName.Text) = _
        New rpt_OTORForm9(txtStudentName.Text, txtElem.Text, txtElemYr.Text, txtHS.Text, _
