...
Public Class fmaPayGradeList
    ...
    Private TABLENAME As String = "employee_grades"

    Private WithEvents SETUPFORM As fmaPayGradeSetup
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT `SysPK_Item`,`Item_Code`,`name`,`description`,`priority`,`max_hours_day`,`max_hours_week`"
        SQL += " FROM " & TABLENAME
        SQL += " ORDER BY `name` "
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("name").DataColumn.Caption = "PAYGRADE NAME"
                ...
                .DisplayColumns("priority").DataColumn.Caption = "PRIORITY"
                .DisplayColumns("priority").Width = 200
                .DisplayColumns("priority").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("priority").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center

                .DisplayColumns("max_hours_day").DataColumn.Caption = "MAX HOURS PER DAY"
                .DisplayColumns("max_hours_day").Width = 200
                .DisplayColumns("max_hours_day").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("max_hours_day").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center

                .DisplayColumns("max_hours_week").DataColumn.Caption = "MAX HOURS PER WEEK"
                .DisplayColumns("max_hours_week").Width = 200
                .DisplayColumns("max_hours_week").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("max_hours_week").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
...
#End Region
        ...
        Try
            For Each iControl As Control In FormControls
                Try
                    ...
                    '          iControl.Text = gvPayGrades.Columns(iControl.Name.Replace("txt", "")).SummaryText
                Catch ex As Exception
                End Try
            Next
        Catch ex As Exception
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaPayGradeSetup
