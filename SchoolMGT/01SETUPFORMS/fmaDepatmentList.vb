Public Class fmaDepatmentList
    ...
    Private TABLENAME As String = "rooms"

    Private WithEvents SETUPFORM As fmaRoomSetupForm
    ...
    Private Sub Attach()
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("name").DataColumn.Caption = "ROOM NAME"
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaRoomSetupForm
