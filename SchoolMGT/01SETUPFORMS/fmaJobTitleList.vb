Public Class fmaJobTitleList
    ...
    Private TABLENAME As String = "job_title"

    Private WithEvents SETUPFORM As fmaJobTitleSetup
...
#Region "Viewers Info"
    Private Sub Attach()
        ...
        Dim SQL As String = "SELECT SysPK_Item,Item_Code,job_title,description"
        SQL += " FROM " & TABLENAME
        ...
        Try
            With tdbViewer.Splits(0)
                ...
                .DisplayColumns("job_title").DataColumn.Caption = "JOB TITLE NAME"
                .DisplayColumns("job_title").Width = 400
                .DisplayColumns("job_title").HeadingStyle.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Center
                .DisplayColumns("job_title").Style.HorizontalAlignment = C1.Win.C1TrueDBGrid.AlignHorzEnum.Near
...
#End Region
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If SETUPFORM Is Nothing Then
            SETUPFORM = New fmaJobTitleSetup
