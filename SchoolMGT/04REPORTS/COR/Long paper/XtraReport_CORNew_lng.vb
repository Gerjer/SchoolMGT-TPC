...
Public Class XtraReport_CORNew_lng
    ...
    'Private Sub XtraReport_CORNew_lng_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
    '    XrLabel1.Text = COMPANY_NAME
    '    XrLabel4.Text = "Contact #: " & COMPANY_MOBILE_NUMBER
    '    XrLabel5.Text = "Email Address: " & COMPANY_EMAIL_ADDRESS
